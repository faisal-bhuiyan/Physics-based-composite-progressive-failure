...
MODULE KTF_CONSTANTS
    ...
    INTEGER*8, PARAMETER :: BASE_FAILURE_PCT = 1
    REAL(KIND=KIND(0.D0)), PARAMETER :: MIN_CYCLE_JUMP = 4.0e4
    REAL(KIND=KIND(0.D0)) :: NELEM = 140, NELEM_LE = 0, NELEM_UMAT = 0, NELEM_UMAT_DELAM = 0

	! Initiate UNSORTED_NCYCLES_FAIL_MATRIX to -1.0, DIMENSION is the number of elements in the model
    REAL(KIND=KIND(0.D0)), DIMENSION(140) :: UNSORTED_NCYCLES_FAIL_MATRIX = -1.D0, SORTED_NCYCLES_FAIL_MATRIX
	REAL(KIND=KIND(0.D0)), DIMENSION(140) :: UNSORTED_NCYCLES_FAIL_FIBER = -1.D0, SORTED_NCYCLES_FAIL_FIBER
	REAL(KIND=KIND(0.D0)), PARAMETER :: MAX_NCYCLES_FAIL_FIBER = 1.0e+9

    ! QSORT parameters
	INTEGER*8 :: LEN = 140, ISIZE = 8
    external COMPAR
    ...
    CHARACTER(*), PARAMETER :: MAT_FILE='/scratch/fbhuiyan/Fiber Failure/Properties.txt'
    CHARACTER(*), PARAMETER :: LOG_FILE='/scratch/fbhuiyan/Fiber Failure/CycleJump_140ElementsModel.txt'
